...
//   GWEN_TTS_PROVIDER=fish node scripts/test-tts.js "Compare this voice."
//   GWEN_TTS_PROVIDER=eleven node scripts/test-tts.js "Now compare this one."
...
const forced = process.env.GWEN_TTS_PROVIDER;
const active = forced
